// $ANTLR 3.2 Sep 23, 2009 12:02:23 Translator.g 2015-10-17 15:04:21
package generator;
...
public class TranslatorLexer extends Lexer {
    ...
    public final void mNL() throws RecognitionException {
        try {
            int _type = NL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Translator.g:1355:4: ( ( '\\r' )? '\\n' )
            // Translator.g:1355:6: ( '\\r' )? '\\n'
            {
            // Translator.g:1355:6: ( '\\r' )?
            int alt2=2;
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            int _type = NUMBER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Translator.g:1370:10: ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
            // Translator.g:1370:12: ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
            {
            // Translator.g:1370:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                int alt3=2;
            ...
            switch (alt5) {
                case 1 :
                    // Translator.g:1370:22: '.' ( '0' .. '9' )+
                    {
                    match('.'); 
                    // Translator.g:1370:26: ( '0' .. '9' )+
                    int cnt4=0;
                    loop4:
                    do {
                        int alt4=2;
    ...
    public final void mVARIABLE() throws RecognitionException {
        try {
            int _type = VARIABLE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Translator.g:1371:10: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
            // Translator.g:1371:12: ( 'a' .. 'z' | 'A' .. 'Z' )+
            {
            // Translator.g:1371:12: ( 'a' .. 'z' | 'A' .. 'Z' )+
            int cnt6=0;
            loop6:
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Translator.g:1372:10: ( '//' (~ ( '\\r' | '\\n' ) )* )
            // Translator.g:1372:12: '//' (~ ( '\\r' | '\\n' ) )*
            {
            match("//"); 

            // Translator.g:1372:17: (~ ( '\\r' | '\\n' ) )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mSTRING() throws RecognitionException {
        try {
            int _type = STRING;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Translator.g:1373:10: ( '\"' (~ ( '\"' ) )* '\"' )
            // Translator.g:1373:12: '\"' (~ ( '\"' ) )* '\"'
            {
            match('\"'); 
            // Translator.g:1373:16: (~ ( '\"' ) )*
            loop8:
            do {
                int alt8=2;
